...
TEST_CASE("RaumAkustik: frequencyToAngularVelocity", "")
{
    ...
    REQUIRE(mc::frequencyToAngularVelocity(mc::Hertz<double>{53.0}).number() == Catch::Approx(333.00882));
    REQUIRE(mc::frequencyToAngularVelocity(mc::Hertz<double>{56.0}).number() == Catch::Approx(351.85838));
    REQUIRE(mc::frequencyToAngularVelocity(mc::Hertz<double>{59.0}).number() == Catch::Approx(370.70793));
}
